...
<html>
    <head>
        ...
        <!-- Facebook Pixel Code -->
            ...
            fbq('init', '1550570688447614');
            fbq('track', 'PageView');
            </script>
            <noscript><img height="1" width="1" style="display:none"
            src="https://www.facebook.com/tr?id=1550570688447614&ev=PageView&noscript=1"
            /></noscript>
    ...
    <body>
        ...
        <section class="prod-content" style="background:#fff;">
            ...
            <article class="content-info">
                <h1 class="content-title content-title-2">
                 Conteúdo : : 
                </h1>
        ...
        <!------------------------- Purchase Section ------------------------->
        <section class="purchase-prod">

            <div class="purchase-prod-center">
